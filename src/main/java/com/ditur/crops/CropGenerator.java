...
public class CropGenerator {
    ...
    /** Obiekt klasy Random służący do losowania typów upraw oraz pozycji. */
    private final Random random = new Random();

    /**
     * Zasiewa okreslony procent powierzchni planszy losowymi uprawami.
     * @param board obiekt planszy, na ktorej generowane sa uprawy
     * @param percentage procentowy wskaznik pokrycia planszy uprawami (0-100)
     */
    ...
    /**
     * Przywraca domyslny stan wszystkim polom na planszy (ustawia CropType.NONE).
     * @param board obiekt planszy przeznaczony do wyczyszczenia
     */
